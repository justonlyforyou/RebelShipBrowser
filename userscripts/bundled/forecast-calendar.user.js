...
(function() {
    ...
    function renderBook() {
        ...
        daysData.forEach((dayData) => {
            ...
            appendPage('AM -', createTableHTML(firstHalf, dayData.day, currentMonth, currentYear));
            appendPage('PM -', createTableHTML(secondHalf, dayData.day, currentMonth, currentYear));
        });
        ...
        const startPage = todayIndex !== -1 ? todayIndex * 2 : 0;
